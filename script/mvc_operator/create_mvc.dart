...
void main(List<String> args) {
  if (args.length != 2) {
    print(
        '使用方法: dart create_mvc_struct.dart <feature_name> <page_name>');
...
void _createPageFolder() {
  ...
  String pageDirectoryPath =
      '$featureDirectoryPath/page/$_pageFileName';
  String filePath =
      '$pageDirectoryPath/${_featureFileName}_${_pageFileName}';
  ...
  // 創建檔案
  String pageInteractiveFilePath =
      '${filePath}_page_interactive.dart';
  ...
  print(
      '   - ${_featureFileName}_${_pageFileName}_page_controller.dart');
  print(
      '   - ${_featureFileName}_${_pageFileName}_page_interactive.dart');
...
part '${_featureFileName}_${_pageFileName}_page_controller.dart';
part '${_featureFileName}_${_pageFileName}_page_interactive.dart';
part '${_featureFileName}_${_pageFileName}_page_model.dart';
...
void _createPageModelContent(String path) {
  String content = '''
part of '${_featureFileName}_${_pageFileName}_page.dart';
...
class $_featureClassName${_pageClassName}PageController extends BasePageController {
  // MARK: - Properties
