...
class DialogItemSearchWidgetController extends GetxController {
  ...
  void onInit() {
    super.onInit();
    LogUtil.i(EnumLogType.debug, '[DialogItemSearchWidgetController] onInit - $hashCode');
    _genCategoryLevel1List();
  }

  @override
  void onClose() {
    LogUtil.i(EnumLogType.debug, '[DialogItemSearchWidgetController] onClose - $hashCode');
  ...
  DialogItemSearchOutputModel genOutputModel() {
    return DialogItemSearchOutputModel(
      ...
      categoryLevel1: _model.selectedCategoryLevel1.value != null
          ? WarehouseNameIdModel(id: _model.selectedCategoryLevel1.value!.id, name: _model.selectedCategoryLevel1.value!.name ?? '')
          : null,
      categoryLevel2: _model.selectedCategoryLevel2.value != null
          ? WarehouseNameIdModel(id: _model.selectedCategoryLevel2.value!.id, name: _model.selectedCategoryLevel2.value!.name ?? '')
          : null,
      categoryLevel3: _model.selectedCategoryLevel3.value != null
          ? WarehouseNameIdModel(id: _model.selectedCategoryLevel3.value!.id, name: _model.selectedCategoryLevel3.value!.name ?? '')
          : null,
    );
  }
