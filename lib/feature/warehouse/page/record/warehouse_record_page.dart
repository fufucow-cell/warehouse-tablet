...
class _LogItem extends StatelessWidget {
  ...
  // 格式化值，null 显示为"未設定"
  String _formatValue(String? value) => value ?? EnumLocale.optionNotSet.tr;
        ...
        contents.add(
          Text(
            EnumLocale.warehouseDescriptionChange.tr
                .replaceAll('{from}', _formatValue(descriptionNameList[0]))
                .replaceAll('{to}', _formatValue(descriptionNameList[1])),
            style: const TextStyle(
              fontSize: 14,
              color: Colors.grey,
            ),
          ...
          contents.add(
            Text(
              EnumLocale.warehouseCategoryChange.tr
                  .replaceAll('{from}', _formatValue(categoryNameList[0]))
                  .replaceAll('{to}', _formatValue(categoryNameList[1])),
              style: const TextStyle(
                fontSize: 14,
                color: Colors.grey,
              ),
        ...
        contents.add(
          Text(
            EnumLocale.warehouseRoomChange.tr
                .replaceAll('{from}', _formatValue(roomNameList[0]))
                .replaceAll('{to}', _formatValue(roomNameList[1])),
            style: const TextStyle(
              fontSize: 14,
              color: Colors.grey,
            ),
