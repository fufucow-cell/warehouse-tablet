...
ItemReservableInfo _$ItemReservableInfoFromJson(Map<String, dynamic> json) {
  return _ItemReservableInfo.fromJson(json);
}

/// @nodoc
mixin _$ItemReservableInfo {
  ...
  @JsonKey(ignore: true)
  $ItemReservableInfoCopyWith<ItemReservableInfo> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ItemReservableInfoCopyWith<$Res> {
  factory $ItemReservableInfoCopyWith(
          ItemReservableInfo value, $Res Function(ItemReservableInfo) then) =
      _$ItemReservableInfoCopyWithImpl<$Res, ItemReservableInfo>;
  @useResult
  $Res call(
      {String? name,
...
/// @nodoc
class _$ItemReservableInfoCopyWithImpl<$Res, $Val extends ItemReservableInfo>
    implements $ItemReservableInfoCopyWith<$Res> {
  _$ItemReservableInfoCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ItemReservableInfoImplCopyWith<$Res>
    implements $ItemReservableInfoCopyWith<$Res> {
  factory _$$ItemReservableInfoImplCopyWith(_$ItemReservableInfoImpl value,
          $Res Function(_$ItemReservableInfoImpl) then) =
      __$$ItemReservableInfoImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String? name,
...
/// @nodoc
class __$$ItemReservableInfoImplCopyWithImpl<$Res>
    extends _$ItemReservableInfoCopyWithImpl<$Res, _$ItemReservableInfoImpl>
    implements _$$ItemReservableInfoImplCopyWith<$Res> {
  __$$ItemReservableInfoImplCopyWithImpl(_$ItemReservableInfoImpl _value,
      $Res Function(_$ItemReservableInfoImpl) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$ItemReservableInfoImpl implements _ItemReservableInfo {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ItemReservableInfoImpl &&
  ...
  _$$ItemReservableInfoImplCopyWith<_$ItemReservableInfoImpl> get copyWith =>
      __$$ItemReservableInfoImplCopyWithImpl<_$ItemReservableInfoImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ItemReservableInfoImplToJson(
      this,
    );
  }
}

abstract class _ItemReservableInfo implements ItemReservableInfo {
  factory _ItemReservableInfo(
          {final String? name,
  ...
  factory _ItemReservableInfo.fromJson(Map<String, dynamic> json) =
      _$ItemReservableInfoImpl.fromJson;
