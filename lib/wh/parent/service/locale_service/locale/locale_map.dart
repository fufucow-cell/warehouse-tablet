/// 多语系 Key 枚举
/// 自动生成，请勿手动修改
/// 生成时间: 2026-02-11T15:11:47.544946
library;
...
enum EnumLocale {
  ...
  airBoxVocStatusPoor,
  airBoxVocValue,
  airConditionerAddWeeklyTimer,
  airConditionerAntiDirectWind,
  airConditionerAutoPowerOffAfterSleepCycle,
  airConditionerCalculateOnlyOnOffHours,
  airConditionerComplete,
  airConditionerConfirmSaveSettings,
  airConditionerCurrentPower,
  airConditionerDetectionNormal,
  airConditionerDifference,
  airConditionerDoNotDisturbDescription,
  airConditionerDoNotDisturbMode,
  airConditionerDryMode,
  airConditionerECO,
  airConditionerEnergyMonitoring,
  airConditionerEnergyUsed,
  airConditionerFanSpeed,
  airConditionerFanSpeedAuto,
  airConditionerFanSpeedDuringSleepCycle,
  airConditionerFanSpeedFilter,
  airConditionerFanSpeedLight,
  airConditionerFanSpeedSetting,
  airConditionerFanSpeedSettingValue,
  airConditionerFanSpeedStrong,
  airConditionerFanSpeedWeak,
  airConditionerFilterRemainingTimeFormat,
  airConditionerFilterReplacementRuntime,
  airConditionerFilterSettings,
  airConditionerGear,
  airConditionerLED,
  airConditionerLastMonth,
  airConditionerLeftRightWind,
  airConditionerLeftRightWind1,
  airConditionerLeftRightWind2,
  airConditionerLeftRightWind3,
  airConditionerLeftRightWind4,
  airConditionerLeftRightWind5,
  airConditionerMode,
  airConditionerModeAuto,
  airConditionerModeCool,
  airConditionerModeDry,
  airConditionerModeFan,
  airConditionerModeFilter,
  airConditionerModeHeat,
  airConditionerMonthlyReport,
  airConditionerMonthlyTarget,
  airConditionerMonthlyTargetSetting,
  airConditionerMonthlyToDate,
  airConditionerOtherMode,
  airConditionerRapid,
  airConditionerReport,
  airConditionerReportTitle,
  airConditionerSaveSettings,
  airConditionerSelfCleaning,
  airConditionerSetPreferredSleepCurve,
  airConditionerSleepCurve,
  airConditionerSleepDuration,
  airConditionerStrongCool,
  airConditionerTemperature,
  airConditionerTemperatureSetting,
  airConditionerThisMonth,
  airConditionerTimerReminderDescription1,
  airConditionerTimerReminderDescription2,
  airConditionerTitle,
  airConditionerTotalUsage,
  airConditionerUpDownWind,
  airConditionerUpDownWind1,
  airConditionerUpDownWind2,
  airConditionerUpDownWind3,
  airConditionerUpDownWind4,
  airConditionerUpDownWind5,
  airConditionerUsageStatistics,
  airConditionerWeek,
  airConditionerWindDirection,
  airConditionerWindDirectionFilter,
  airConditionerWindDirectionSetting,
  all,
  appTitle,
  cabinet,
  category,
