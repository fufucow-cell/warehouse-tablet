import 'package:engo_terminal_app3/wh/feature/air_box/page/record/air_box_record_page_controller.dart';
...
class AirBoxRecordPage extends GetView<AirBoxRecordPageController> {
  final AirBoxRecordPageRouterData routerData;
  const AirBoxRecordPage({super.key, required this.routerData});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<AirBoxRecordPageController>(
      init: AirBoxRecordPageController(routerData),
      builder: (controller) {
        return Scaffold(
...
class _TopBar extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final controller = Get.find<AirBoxRecordPageController>();
    return Row(
      children: [
        CustIconButton(
          ...
          onTap: () {
            controller.interactive(EnumAirBoxRecordPageInteractive.tapBackButton);
          },
        ),
        Expanded(
          child: Center(
        ...
        CustIconButton(
          ...
          onTap: () {
            controller.interactive(EnumAirBoxRecordPageInteractive.tapHelpButton);
          },
        ),
      ],
    );
                ...
                child: _FilterTab(
                  ...
                  onTap: () {
                    controller.interactive(
                      EnumAirBoxRecordPageInteractive.tapTimeFilter,
            ...
            children: [
              CustDropdownMenuButton.popupMenuButton(
                ...
                onValueSelected: (value) {
                  controller.interactive(
                    EnumAirBoxRecordPageInteractive.tapDataTypeFilter,
                    data: value,
                  );
                },
                fontSize: 32.0.scale,
            ...
            children: [
              Expanded(
                child: _DataTypeTab(
                  ...
                  isSelected: selectedType == EnumAirBoxDataType.temperature,
                  onTap: () {
                    controller.interactive(
                      EnumAirBoxRecordPageInteractive.tapDataTypeFilter,
                      data: EnumAirBoxDataType.temperature,
                    );
                  },
                ),
              ),
              ...
              Expanded(
                child: _DataTypeTab(
                  ...
                  isSelected: selectedType == EnumAirBoxDataType.humidity,
                  onTap: () {
                    controller.interactive(
                      EnumAirBoxRecordPageInteractive.tapDataTypeFilter,
                      data: EnumAirBoxDataType.humidity,
                    );
                  },
                ),
              ),
              ...
              Expanded(
                child: _DataTypeTab(
                  ...
                  isSelected: selectedType == EnumAirBoxDataType.pm25,
                  onTap: () {
                    controller.interactive(
                      EnumAirBoxRecordPageInteractive.tapDataTypeFilter,
                      data: EnumAirBoxDataType.pm25,
                    );
                  },
                ),
              ),
