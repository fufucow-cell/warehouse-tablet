...
import 'package:engo_terminal_app3/wh/feature/warehouse/page/category/ui/dialog_category_edit/dialog_category_edit_widget_controller.dart';
          ...
          children: [
            ...
            if (controller.selectedLevel1Rx.value != null) ...[
              ...
              _DropdownField(
                ...
                onDelete: () => controller.interactive(
                  EnumDialogCategoryEditWidgetInteractive.tapDeleteLevel2Button,
                  data: context,
                ),
              ),
            ],
