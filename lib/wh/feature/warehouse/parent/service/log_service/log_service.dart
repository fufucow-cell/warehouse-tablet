...
import 'package:engo_terminal_app3/wh/feature/warehouse/parent/util/time_util.dart';
...
class LogService extends GetxService {
  ...
  void setEnableLog(bool enable) {
    _model.enableLog = enable && kDebugMode;
  }
  ...
  /// 打印一般資訊
  void i(EnumLogType type, String message) {
    _log(type, message);
  }
