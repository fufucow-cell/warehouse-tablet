import 'package:engo_terminal_app3/wh/feature/air_quality/page/reference/air_quality_reference_page_controller.dart';
...
class AirQualityReferencePage extends GetView<AirQualityReferencePageController> {
  final EnumAirQualityDataType? type;
  const AirQualityReferencePage({super.key, this.type});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<AirQualityReferencePageController>(
      init: AirQualityReferencePageController(type),
      builder: (controller) {
...
class _TopBar extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final controller = Get.find<AirQualityReferencePageController>();
    return Row(
      children: [
        CustIconButton(
          ...
          onTap: () {
            controller.interactive(EnumAirQualityReferencePageInteractive.tapBackButton);
          },
        ),
        Expanded(
          child: Center(
        ...
        onValueSelected: (value) {
          if (value != null) {
            controller.interactive(
              EnumAirQualityReferencePageInteractive.tapDataTypeDropdown,
              data: value,
            );
          }
        },
          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  standard.dataType.enumImage.image(
                    size: Size.square(42.0.scale),
                    color: EnumColor.textPrimary.color,
                  ),
