...
**功能：**
- 从 `lib/wh/parent/constant/theme/color_data.dart` 中提取所有颜色 key
...
**功能：**
- 扫描 `lib/wh/parent/assets/images/` 目录下的所有图片文件
...
```bash
# 1. 添加新图片到 common/ 目录
# lib/wh/parent/assets/images/common/new_icon.png
...
**功能：**
- 从 `lib/wh/parent/constant/locales/zh_tw.dart` 中提取所有 key
